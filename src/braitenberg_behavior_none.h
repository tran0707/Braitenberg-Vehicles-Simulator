/**
* @file braitenberg_behavior_none.h
*
* @copyright 2019 CSCI 3081 tran0707, All right reserved.
*/

#ifndef SRC_BRAITENBERG_BEHAVIOR_NONE_H_
#define SRC_BRAITENBERG_BEHAVIOR_NONE_H_
...
/**
* @brief A class for all braitenberg vehicle none behavior
* 
* This class uses to calculate the WheelVelocity of each BV based on
* none behavior
*/
class Braitenberg_behavior_none : public Braitenberg_behaviors {
 public:
/**
* @brief Default constructor for BV none behavior.
*/
Braitenberg_behavior_none();
virtual ~Braitenberg_behavior_none();

/**
* @brief Calculate the WheelVelocity of the closest_entity in case of none
*
...
#endif  // SRC_BRAITENBERG_BEHAVIOR_NONE_H_
